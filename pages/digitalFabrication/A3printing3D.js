                        ...
                        <Box
                            ...
                            <Center>
                                <Box
                                    ...
                                    overflow="hidden"
                                >
                                    <ImageCarousel images={part2} height="500px" />
                                </ Box>
                            </Center>
                        </Box>
                        ...
                        <Box flexGrow={1} display="inline-block" overflow="hidden">
                            <Box display="inline-block" overflow="hidden">
                                ...
                                <Text fontSize="xl">
                                    ...
                                    <Link isExternal={true} href="https://cuttle.xyz/"> Cuttle</Link> (I tried Rhino and lost my mind for 3 hours before I went back to Cuttle) and recreated my sketch into a <b>.svg</b>. I created different variations of the same claw clip by rotating the claw and positioning them as different angles. 
                                </Text>
                            ...
                            <Box
                                ...
                                <Center>
                                    <Box
                                        ...
                                        overflow="hidden"
                                    >
                                        <ImageCarousel images={part3} height="500px" />
                                    </ Box>
                                </Center>
                            </Box>
                        </Section>
                        ...
                        <Box
                            ...
                            <Center>
                                <Box
                                    ...
                                    overflow="hidden"
                                >
                                    <ImageCarousel images={iter} height="375px" />
                                </ Box>
                            </Center>
                        </Box>
                        ...
                        <Section delay={0.4}>
                            ...
                            <Box flexGrow={1} display="inline-block" overflow="hidden">
                                <Box display="inline-block" overflow="hidden">
                                    ...
                                    <Text fontSize="xl">
                                        I went back to Cuttle and flipped the claws. I went into Rhino and extruded less (from 10mm to 5mm). I imported the new STL into Orca and did another test print with the same draft settings.
                                    </Text>

                                    <br />

                                    <Text fontSize="xl">
                                        The second iteration was able to open and close much more easily, but still retained its shape! Now I just needed to print out 15 of these crab clips!
                                    </Text>

                                    <br />

                                    <Text fontSize="xl">
                                        Orca Slicer allows you to create multiple plates and orient your object for each plate, so I made each of print plates have a different variation of my crab clip. I decided to use the <b>0.20mm Standard Quality</b> setting to compromise print time and quality of print. This meant each plate would take about <b>1 hour</b> to print (3 hours total).
                                    </Text>
                                </Box>
                            </Box>
                        </Section>
                        ...
                        <Box
                            ...
                            <Center>
                                <Box
                                    ...
                                    borderRadius="3xl"
                                >
                                    <Image src={gif} w="600px" h="300px" borderRadius='3xl' alt="ShakeTestGIF" />
                                </ Box>
                            </Center>
                        </Box>
